...
export class AppservicesService {
  ...
  SERVER_URL_INSERT_UPDATE_MEMBER;
  ...
  constructor(private http: HttpClient, private commonHttpService: CommonHttpService) {
    ...
    this.SERVER_URL_INSERT_UPDATE_MEMBER = this.appendpoint + AppConstant.API_CONFIG.API_URL.MEMBERS.INSERTUPDATEMEMBER;
  ...
  public insertUpdateMember(memberData: any) {
