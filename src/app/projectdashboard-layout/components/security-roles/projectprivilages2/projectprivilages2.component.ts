...
@Component({
  ...
  templateUrl: './projectprivilages2.component.html',
  styleUrls: ['./projectprivilages2.component.scss']
})
export class Projectprivilages2Component implements OnInit {
...
// Angular Material Tree-Node End
  ...
  constructor(
    ...
    private database: ChecklistDatabase2
