...
@Component({
  ...
  templateUrl: './projectprivilages1.component.html',
  styleUrls: ['./projectprivilages1.component.scss']
})
export class Projectprivilages1Component implements OnInit {
...
// Angular Material Tree-Node End
  ...
  constructor(
    ...
    private database: ChecklistDatabase1
